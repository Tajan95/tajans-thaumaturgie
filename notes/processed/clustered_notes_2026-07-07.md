...
Dies passt direkt zu `docs/spell_system/visual_spell_language.md` und DD-007.
...
|---|---|
| Müssen Zauber physisch sein? | DD-007, `docs/spell_system/visual_spell_language.md` |
| Makros sind praktisch nötig | DD-006, `notes/archive/working_model_from_initial_notes.md` |
| Klare visuelle Repräsentation | DD-007, `docs/spell_system/visual_spell_language.md` |
